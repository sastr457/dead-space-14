...
ent-VisitorIDCard = ID-карта посетителя
    .desc = { ent-IDCardStandard.desc }
ent-CentcomIDCard = ID-карта офицера ЦК
    .desc = { ent-IDCardStandard.desc }
...
ent-CentcomIDCardSyndie = ID-карта офицера командования
    .desc = { ent-IDCardStandard.desc }
    .suffix = Фальшивый
ent-CentcomOfficialIDCard = ID-карта представителя ЦК
    .desc = { ent-CentcomIDCard.desc }
ent-CentcomAdministratorIDCard = ID-карта администратора ЦК
    .desc = { ent-CentcomIDCard.desc }
ent-CentcomOperatorIDCard = ID-карта оператора ЦК
    .desc = { ent-CentcomIDCard.desc }
ent-CentcomSpecialOperationsOfficerIDCard = ID-карта офицера специальных операций
    .desc = { ent-CentcomIDCard.desc }
ent-CentcomFieldOfficerIDCard = ID-карта полевого офицера КСО
    .desc = { ent-CentcomIDCard.desc }
