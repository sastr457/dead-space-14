...
reagent-desc-puncturase = Шипучее химическое вещество, залечивающее колотые ранения, ценой небольшого отравления.
reagent-name-puncturase-tranexamic = пунктураз & транексамовая кислота
...
reagent-name-pyrazine-dermaline = пиразин & дермалин
